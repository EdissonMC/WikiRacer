...
void fileToSet(std::ifstream& inp,   std::set<std::string>& setWords){
        ...
        if(itr_result1 != word.end()){
            ...
            if(itr_result2 != word.end()){
                 ...
                 if (  IsWikiLink(    std::string(itr_result1 +6,   itr_result2)   ) ) {
                       std::cout<<  std::string(itr_result1 +6,   itr_result2) <<std::endl;
         ...
         //  std::cout << word <<std::endl;
           /// std::cout << "Probando si es un wikilink "<<IsWikiLink(word)<<std::endl;
        // if (IsWikiLink(word)){
        //     std::cout << word <<std::endl;
...
int main(){
    ...
    std::ifstream file1(kPath+"ksound.txt");
    std::set<std::string> setLinks;
    
    
    fileToSet(file1 , setLinks  );
     
    // std::string fileInString = fileToString(file1);

    // std::string::iterator startStringtItr = fileInString.begin();
    // std::string::iterator endStringItr = fileInString.end();
    
    // std::set<std::string> setLinks;
    // std::string word;
    
    // std::cout <<fileInString;
